...
namespace NAudio.Dsp
{
	internal class WdlResampler
	{
		...
		{
			m_sincsize = ((sinc && sinc_size >= 4) ? ((sinc_size <= 8192) ? sinc_size : 8192) : 0);
			m_sincoversize = ((m_sincsize == 0) ? 1 : ((sinc_interpsize <= 1) ? 1 : ((sinc_interpsize < 4096) ? sinc_interpsize : 4096)));
			m_filtercnt = ((m_sincsize == 0) ? ((filtercnt > 0) ? ((filtercnt < 4) ? filtercnt : 4) : 0) : 0);
